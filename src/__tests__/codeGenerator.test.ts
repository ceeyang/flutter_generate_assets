...
describe('generateDartCode', () => {
  it('includes the generated file header', () => {
    ...
    expect(code).toContain('//  Flutter Generate Assets');
    expect(code).toContain('//  VSCode  https://github.com/ceeyang/flutter_generate_assets');
    expect(code).toContain('//  CLI     https://github.com/ceeyang/generate_assets');
